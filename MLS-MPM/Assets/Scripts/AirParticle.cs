...
public class AirParticle : Particle
{
    ...
    private double mass = 0.05; // 0.5 might be too high, but anything lower, and it destabilizes the sim. I'm not sure where the particles end up going, but they aren't in the viewport. It doesn't seem to change their next position computation by more than like 0.01 though.
